...
const Template = ({ children, title = 'PrimeFaces Verona' }) => {            
    ...
    // Función corregida para manejar el toggle del menú    
    const toggleMenu = () => {    
        ...
        if (isMenuVisible) {    
            // Ocultar menú - aplicar las clases CSS que espera Verona    
            wrapper?.classList.add('layout-menu-static-inactive');    
            menuWrapper?.classList.remove('layout-menu-wrapper-active');    
            menuButton?.classList.remove('menu-button-active');    
        } else {    
            // Mostrar menú - aplicar las clases CSS que espera Verona    
            wrapper?.classList.remove('layout-menu-static-inactive');    
            menuWrapper?.classList.add('layout-menu-wrapper-active');    
    ...
    return (            
        <>            
            ...
            <div className="layout-wrapper layout-menu-static">           
                <Topbar toggleMenu={toggleMenu} isMenuVisible={isMenuVisible} />            
